...
namespace FlorianWolters.Office.Word.AddIn.CBA.EventHandlers
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAttachedTemplateEventHandler"/> class.
        /// </summary>
        ...
        public UpdateAttachedTemplateEventHandler(ICommand command, IExceptionHandler exceptionHandler)
