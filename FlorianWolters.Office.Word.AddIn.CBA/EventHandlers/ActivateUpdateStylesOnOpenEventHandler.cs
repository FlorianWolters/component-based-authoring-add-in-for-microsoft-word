...
namespace FlorianWolters.Office.Word.AddIn.CBA.EventHandlers
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivateUpdateStylesOnOpenEventHandler"/> class.
        /// </summary>
        ...
        public ActivateUpdateStylesOnOpenEventHandler(ICommand command, IExceptionHandler exceptionHandler)
