...
namespace FlorianWolters.Office.Word.AddIn.CBA.Factories
{
    ...
    /// <summary>
    /// The class <see cref="WriteCustomDocumentPropertiesFactory"/> implements a <i>FactoryMethod</i> to create
    /// instances of <see cref="UpdateAttachedTemplateEventHandler"/>.
    /// </summary>
    public sealed class WriteCustomDocumentPropertiesFactory : EventHandlerFactory
    {
        ...
        {
            return new WriteCustomDocumentPropertiesEventHandler(command, exceptionHandler);
        }
    }
}
