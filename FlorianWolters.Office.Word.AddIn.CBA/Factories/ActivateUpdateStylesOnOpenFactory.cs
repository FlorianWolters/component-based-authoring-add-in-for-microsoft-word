...
namespace FlorianWolters.Office.Word.AddIn.CBA.Factories
{
    ...
    /// <summary>
    /// The class <see cref="ActivateUpdateStylesOnOpenFactory"/> implements a <i>FactoryMethod</i> to create instances
    /// of <see cref="UpdateAttachedTemplateEventHandler"/>.
    /// </summary>
    public sealed class ActivateUpdateStylesOnOpenFactory : EventHandlerFactory
    {
        ...
        {
            return new ActivateUpdateStylesOnOpenEventHandler(command, exceptionHandler);
        }
    }
}
