//------------------------------------------------------------------------------
// <copyright file="UpdateFieldsFactory.cs" company="Florian Wolters">
...
namespace FlorianWolters.Office.Word.AddIn.CBA.Factories
{
    ...
    /// <summary>
    /// The class <see cref="UpdateFieldsFactory"/>implements a <i>FactoryMethod</i> to create instances of <see
    /// cref="UpdateAttachedTemplateEventHandler"/>.
    /// </summary>
    public sealed class UpdateFieldsFactory : EventHandlerFactory
    {
        /// <summary>
        /// The <i>Singleton</i> instance of the <see cref="UpdateFieldsFactory"/>.
        /// </summary>
        public static readonly UpdateFieldsFactory Instance = new UpdateFieldsFactory();

        /// <summary>
        /// Prevents a default instance of the <see cref="UpdateFieldsFactory"/> class from being created.
        /// </summary>
        private UpdateFieldsFactory()
        {
        }
        ...
        {
            return new UpdateFieldsCommand(application);
        }
        ...
        {
            return new UpdateFieldsEventHandler(command, exceptionHandler);
        }
    }
}
