//------------------------------------------------------------------------------
// <copyright file="RefreshCustomXMLPartsFactory.cs" company="Florian Wolters">
...
namespace FlorianWolters.Office.Word.AddIn.CBA.Factories
{
    ...
    /// <summary>
    /// The class <see cref="RefreshCustomXMLPartsFactory"/> implements a <i>FactoryMethod</i> to create instances of
    /// <see cref="UpdateAttachedTemplateEventHandler"/>.
    /// </summary>
    public sealed class RefreshCustomXMLPartsFactory : EventHandlerFactory
    {
        /// <summary>
        /// The <i>Singleton</i> instance of the <see cref="RefreshCustomXMLPartsFactory"/>.
        /// </summary>
        public static readonly RefreshCustomXMLPartsFactory Instance = new RefreshCustomXMLPartsFactory();

        /// <summary>
        /// Prevents a default instance of the <see cref="RefreshCustomXMLPartsFactory"/> class from being created.
        /// </summary>
        private RefreshCustomXMLPartsFactory()
        {
        }
        ...
        {
            return new RefreshCustomXMLPartsCommand(application);
        }
        ...
        {
            return new RefreshCustomXMLPartsEventHandler(command, exceptionHandler);
        }
    }
}
